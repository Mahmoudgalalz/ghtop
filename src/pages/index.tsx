...
import { validate_user } from "../utils";
...
export function Main(){
    ...
    return (
        <section className="flex bg-gradient-to-t h-screen from-[#141521] items-center relative to-[#141521]">
            ...
            <div className="flex flex-col justify-center gap-3 mt-10 sm:flex-row">
              <form className="w-full lg:w-auto bg-white/20 lg:mx-auto p-1.5 rounded-2xl">
                <div className="w-full lg:flex lg:items-center">
                  ...
                  <button onClick={handleClick} className="w-full lg:w-auto 0 active:bg-slate-600 active:text-white/80 before:transition-colors bg-white flex-none font-medium hover:bg-indigo-900 hover:text-white inline-flex justify-center lg:ml-4 outline-2 outline-offset-2 px-6 py-2.5 relative rounded-xl text-indigo-500">
